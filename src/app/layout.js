...
export const metadata = {
  title: "GrowZoneYT",
  description:
    "GrowZoneYT is a platform that provides services to grow your youtube, instagram and facebook accounts.",
  icons: {
    icon: "/favicon.ico",
  },
};
      ...
      >
        <div className="navbar bg-base-300 shadow-sm">
          <div className="navbar-start">
            <a
              href="/"
              className="btn text-xl font-bold text-blue-600 bg-base-300 border-none"
            >
              GrowZoneYT
            </a>
          </div>
        ...
        <div className="min-h-[calc(100vh-226px)] max-w-6xl mx-auto">
          {children}
        </div>
        ...
        <footer className="footer footer-horizontal footer-center bg-base-300 text-base-content rounded p-10">
          <nav className="grid grid-flow-col gap-4">
            ...
            <a href="/term-condition" className="link link-hover">
              Terms & Conditions
            </a>
